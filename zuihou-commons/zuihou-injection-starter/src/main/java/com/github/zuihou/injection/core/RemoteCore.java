...
public class RemoteCore {
    ...
    public RemoteCore(InjectionProperties remoteProperties) {
        ...
        this.remoteFieldMap = new HashMap<String, InjectionField>();
        this.caches = CacheBuilder.newBuilder()
                ...
                .build(new CacheLoader<String, Map<String, Object>>() {
                    ...
                    public Map<String, Object> load(String key) throws Exception {
                        log.info("首次读取缓存: " + key);
                        InjectionField remoteField = remoteFieldMap.get(key);
     ...
     * @throws Throwable
     */
    public Object injectionAnno(ProceedingJoinPoint pjp, InjectionResult anno) throws Throwable {
    ...
    public void injectionList(Class clazz, List<?> result) throws ExecutionException {
        ...
        for (Field field : fields) {
            InjectionField annotation = field.getAnnotation(InjectionField.class);
            if (annotation == null) {
                continue;
            }
