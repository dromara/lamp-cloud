...
import com.github.zuihou.authority.enumeration.core.ResourceType;
...
@ApiModel(value = "CAuthResource", description = "资源")
public class CAuthResource extends Entity<Long> {
    ...
    @Builder
    public CAuthResource(Long id, Long createUser, LocalDateTime createTime, Long updateUser, LocalDateTime updateTime,
