...
@ApiModel(value = "CAuthRole", description = "角色")
public class CAuthRole extends Entity<Long> {
    ...
    @Builder
    public CAuthRole(Long id, Long createUser, LocalDateTime createTime, Long updateUser, LocalDateTime updateTime,
