...
@TableName("c_common_log")
@ApiModel(value = "Log", description = "系统日志")
public class Log extends SuperEntity<Long> {
    ...
    @Length(max = 1000, message = "请求参数长度不能超过1000")
    @TableField("params")
    ...
    @Length(max = 1000, message = "返回值长度不能超过1000")
    @TableField("result")
    ...
    @Length(max = 1000, message = "异常详情信息长度不能超过1000")
    @TableField("ex_desc")
    ...
    @Builder
    public Log(Long id, LocalDateTime createTime, Long createUser,
