...
import com.github.zuihou.authority.enumeration.core.MenuType;
import com.github.zuihou.authority.enumeration.core.TargetType;
...
@ApiModel(value = "CAuthMenu", description = "菜单")
public class CAuthMenu extends Entity<Long> {
    ...
    @Builder
    public CAuthMenu(Long id, Long createUser, LocalDateTime createTime, Long updateUser, LocalDateTime updateTime,
