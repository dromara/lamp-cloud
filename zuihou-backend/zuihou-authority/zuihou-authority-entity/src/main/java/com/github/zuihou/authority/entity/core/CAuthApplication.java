...
@ApiModel(value = "CAuthApplication", description = "应用")
public class CAuthApplication extends Entity<Long> {
    ...
    @Builder
    public CAuthApplication(Long id, Long createUser, LocalDateTime createTime, Long updateUser, LocalDateTime updateTime,
