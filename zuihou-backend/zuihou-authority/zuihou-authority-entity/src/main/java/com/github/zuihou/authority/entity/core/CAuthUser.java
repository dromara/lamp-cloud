...
import com.github.zuihou.authority.enumeration.core.AccountType;
import com.github.zuihou.authority.enumeration.core.Sex;
...
@ApiModel(value = "CAuthUser", description = "账号")
public class CAuthUser extends Entity<Long> {
    ...
    @Builder
    public CAuthUser(Long id, Long createUser, LocalDateTime createTime, Long updateUser, LocalDateTime updateTime,
