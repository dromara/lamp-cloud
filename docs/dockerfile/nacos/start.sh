...
docker stop zuihou_nacos
docker rm zuihou_nacos
docker run -idt --name zuihou_nacos --restart=always \
        ...
        -e MYSQL_SERVICE_HOST=192.168.2.178 -e MYSQL_SERVICE_DB_NAME=zuihou_nacos -e MYSQL_SERVICE_PORT=3218 \
