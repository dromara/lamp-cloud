...
3.项目中：zuihou-admin-cloud/zuihou-dependencies/pom.xml 中 profiles 相关的配置移动到了
...
mvn versions:set -DnewVersion="3.9.0-java17-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false

## 打标签

```
git tag 3.9.0-java17
