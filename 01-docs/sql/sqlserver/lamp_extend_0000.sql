...
-- ----------------------------
IF
EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[e_block_list]') AND type IN ('U'))
...
-- ----------------------------
CREATE
NONCLUSTERED INDEX [task_id_tel_num]
...
-- ----------------------------
CREATE
NONCLUSTERED INDEX [tempate_id_topic_content]
ON [dbo].[e_sms_task] (
  [template_id] ASC,
  [topic] ASC,
  [content] ASC
