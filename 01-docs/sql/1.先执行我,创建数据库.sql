...
lamp_none、lamp_activiti、lamp_column_all、lamp_defaults、lamp_base_0000、lamp_extend_0000 是lamp-cloud项目需要的库
 */
-- none 模式
...
CREATE DATABASE IF NOT EXISTS `lamp_column_all` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
CREATE DATABASE IF NOT EXISTS `lamp_activiti` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
