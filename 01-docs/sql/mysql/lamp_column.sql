...
ALTER TABLE c_area ADD UNIQUE INDEX uk_area_code(tenant_code, code) USING BTREE;
...
ALTER TABLE c_parameter ADD UNIQUE INDEX uk_param_key(tenant_code, key_) USING BTREE;
...
ALTER TABLE c_resource ADD UNIQUE INDEX uk_res_code(tenant_code, code) USING BTREE;
ALTER TABLE c_role DROP INDEX uk_role_code;
ALTER TABLE c_role ADD UNIQUE INDEX uk_role_code(tenant_code, code) USING BTREE;
...
ALTER TABLE c_role_org ADD UNIQUE INDEX uk_role_org(tenant_code, org_id,role_id) USING BTREE;
ALTER TABLE c_user DROP INDEX uk_user_account;
ALTER TABLE c_user ADD UNIQUE INDEX uk_user_account(tenant_code, account) USING BTREE;
