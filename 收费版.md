...
*****
## 购买方式：
联系QQ:  **306479353**，微信：**tyh306479353**， 通过支付宝、微信等方式支付后，作者会将您拉入内部群, 并离线发送项目源码、完整视频等资料。
...
1. 多数据源模式：300元    （已完成）
2.  完整项目高清视频：400元（正在录制...） （预计2020年7月13日左右完成）（最下方可以看到已完成视频的目录）
3. zuul/gateway 动态路由：249元  （待完善）
...
1. 750元（5折）购买完整的收费版，后续每完善一个功能，第一时间发送给您（含赠送文档，已购文档的用户不支持补购买文档的差价） （后面若新增加的功能大于上面5点，价格可能会上调，但价格不影响已经购买的朋友，功能照样赠送给您，所以，越早购买越优惠.）
...
| 完整项目视频 | 无 | 有 | 正在录制 | 开源版视频只讲了如何启动项目<br />收费版视频讲解如何 从0到1如何搭建本框架、如何二次开发、各个组件的设计原理、一些小技巧 |
