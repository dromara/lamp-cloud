...
| 允许将二开之后的源码提供给第三方 | 有 | 无 | 有 | 完成 | 开源版:只需要遵循Apache协议任意使用<br />个人版:源码禁止直接或者间接提供给第三方。<br/>企业版：源码可以二次开发或修改后可以提供给客户。<br/> 禁止用任何版本二次开发出同类产品售卖。<br/> **违反必究！！！** |
| 转卖、售卖、赠送源码、视频、文档给第三方 | 无 | 无 | 无 | 完成 | 违反必究！！！ |
| 基于本产品包装成同种类别的衍生产品进行源码、文档售卖盈利 | 无 | 无 | 无 | 完成 | 可以作为公司商业项目开发、交付使用，但严禁修改成类似SaaS快速开发平台、开发框架等同类产品进行售卖盈利！<br/> **违反必究！！！** |
