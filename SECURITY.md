...
Thanks for helping keep lamp-cloud and the wider [dromara](https://github.com/dromara) ecosystem secure.
...
1. **GitHub's Private Vulnerability Reporting (preferred).**
   Open a private security advisory at <https://github.com/dromara/lamp-cloud/security/advisories/new>.
...
lamp-cloud is a Spring Cloud microservice / SaaS development platform. The maintainers support security fixes on the latest minor release. Older releases will not generally receive backports.

In-scope vulnerability classes include:

- Authentication / authorization bypass
- Tenant-isolation flaws (cross-tenant data access)
- Server-side request forgery (SSRF), command injection, path traversal
- SQL injection in ORM / dynamic-SQL paths
...
Reporters who have helped harden lamp-cloud via responsible disclosure will be listed here once the corresponding advisory is published.
