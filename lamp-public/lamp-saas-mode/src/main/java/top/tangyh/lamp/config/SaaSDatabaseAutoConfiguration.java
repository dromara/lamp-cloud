...
public class SaaSDatabaseAutoConfiguration extends BaseMasterDatabaseConfiguration {

    public SaaSDatabaseAutoConfiguration(MybatisPlusProperties properties,
