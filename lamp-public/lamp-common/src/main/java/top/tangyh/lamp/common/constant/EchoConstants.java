...
public class EchoConstants {
     ...
     * 组织 feign查询类
     */
    public static final String ORG_ID_FEIGN_CLASS = "top.tangyh.lamp.oauth.api.OrgApi";
     ...
     * 用户 feign查询类
     */
    public static final String USER_ID_FEIGN_CLASS = "top.tangyh.lamp.oauth.api.UserApi";
     ...
     * 组织 feign查询类
     */
    public static final String STATION_ID_FEIGN_CLASS = "top.tangyh.lamp.oauth.api.StationApi";
